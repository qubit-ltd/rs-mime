...
use crate::CONFIG_COMMAND_OUTPUT_MAX_BYTES;
use crate::CONFIG_COMMAND_TIMEOUT;
use crate::CONFIG_MEDIA_STREAM_CLASSIFIER_DEFAULT;
use crate::CONFIG_MEDIA_STREAM_MAX_STAGING_SIZE;
use crate::CONFIG_MIME_AMBIGUOUS_MIME_MAPPING;
use crate::CONFIG_MIME_DETECTOR_DEFAULT;
use crate::CONFIG_MIME_DETECTOR_FALLBACKS;
use crate::CONFIG_MIME_ENABLE_PRECISE_DETECTION;
use crate::CONFIG_MIME_MAX_BUFFER_SIZE;
use crate::CONFIG_MIME_PRECISE_DETECTION_PATTERNS;
use crate::DEFAULT_COMMAND_OUTPUT_MAX_BYTES;
use crate::DEFAULT_COMMAND_TIMEOUT;
use crate::DEFAULT_ENABLE_PRECISE_DETECTION;
use crate::DEFAULT_MEDIA_STREAM_CLASSIFIER;
use crate::DEFAULT_MEDIA_STREAM_MAX_STAGING_SIZE;
use crate::DEFAULT_MIME_DETECTOR;
use crate::DEFAULT_MIME_DETECTOR_FALLBACKS;
use crate::DEFAULT_MIME_MAX_BUFFER_SIZE;
use crate::ENV_COMMAND_OUTPUT_MAX_BYTES;
use crate::ENV_COMMAND_TIMEOUT;
use crate::ENV_MEDIA_STREAM_CLASSIFIER_DEFAULT;
use crate::ENV_MEDIA_STREAM_MAX_STAGING_SIZE;
use crate::ENV_MIME_DETECTOR_AMBIGUOUS_MIME_MAPPING;
use crate::ENV_MIME_DETECTOR_DEFAULT;
use crate::ENV_MIME_DETECTOR_ENABLE_PRECISE_DETECTION;
use crate::ENV_MIME_DETECTOR_FALLBACKS;
use crate::ENV_MIME_DETECTOR_PRECISE_DETECTION_PATTERNS;
use crate::ENV_MIME_MAX_BUFFER_SIZE;
use crate::MimeError;
...
fn detector_selection_error(error: ProviderSelectionBuildError) -> MimeError {
    ...
    if let Some(source) = error.selector_error() {
        MimeError::InvalidDetectorName {
            name: source.input().to_owned(),
            reason,
        }
    } else if error.is_empty_chain() {
        MimeError::EmptyDetectorName
    } else {
        MimeError::NoAvailableDetector { reason }
    }
}
...
fn classifier_selection_error(error: ProviderSelectionBuildError) -> MimeError {
    ...
    if let Some(source) = error.selector_error() {
        ...
        MimeError::NoAvailableClassifier { reason }
    }
}
