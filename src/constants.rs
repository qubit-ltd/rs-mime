...
/// implementation.
pub const ENV_MEDIA_STREAM_CLASSIFIER_DEFAULT: &str =
...
pub const ENV_MIME_DETECTOR_AMBIGUOUS_MIME_MAPPING: &str =
...
/// implementation.
pub const CONFIG_MEDIA_STREAM_CLASSIFIER_DEFAULT: &str =
    "mime.media.stream.classifier.default";
...
pub const CONFIG_MIME_PRECISE_DETECTION_PATTERNS: &str =
    "mime.precise.detection.patterns";

/// Configuration key defining ambiguous extension to MIME mappings.
pub const CONFIG_MIME_AMBIGUOUS_MIME_MAPPING: &str =
